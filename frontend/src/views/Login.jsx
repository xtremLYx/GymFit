...
export default function Login() {
  ...
  const head = <>
    <div style={{ display: 'flex', justifyContent: 'center', marginBottom: 10 }}>
      <img src="/icon-180.png" alt="GymFit" style={{ width: 72, height: 72, borderRadius: 18, boxShadow: '0 8px 24px rgba(0,0,0,0.5)' }} />
    </div>
    <h1 style={{ fontSize: 34, fontWeight: 700, letterSpacing: '-.028em', margin: '4px 0 4px' }}>GymFit</h1>
  </>
